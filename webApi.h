...
static void setupWebRoutes() {
    ...
    server.on("/api/settings", HTTP_POST, []() {
        ...
        if (doc.containsKey("textBlastTextCustomMessage")) prefTextBlastTextCustomMessage = doc["textBlastTextCustomMessage"];
        if (doc.containsKey("textBlastText")) prefTextBlastText = sanitizeText(doc["textBlastText"].as<String>());
        if (doc.containsKey("textBlastTextColor")) prefTextBlastTextColor = doc["textBlastTextColor"];
        if (doc.containsKey("textBlastBackgroundColor")) prefTextBlastBackgroundColor = doc["textBlastBackgroundColor"];
        if (doc.containsKey("textBlastCycles")) prefTextBlastCycles = doc["textBlastCycles"];
        if (doc.containsKey("textBlastSpeed")) prefTextBlastSpeed = doc["textBlastSpeed"];
